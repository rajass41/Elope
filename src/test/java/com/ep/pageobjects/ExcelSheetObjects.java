...
public class ExcelSheetObjects {
	...
	//Test scenario's id of TestCasesSheet
		    ...
		    public static final String SignupWithRequiredData="Signup";
		    public static final String LoginWithValidCredentials="Login";
		    public static final String StudentForm="StudentFormFill";
		    public static final String StudentWLForm="StudentWaitingListFormfill";
		    public static final String ContactUsForm="ContactUsForm";
		    public static final String Changepassword="Changepassword";
		    public static final String ProfileUpdate="ProfileUpdate";
		    public static final String Taxstatement="Taxstatement";
